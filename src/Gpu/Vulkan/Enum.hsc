...
enum "StructureType" ''#{type VkStructureType}
	...
	("StructureTypeCudaModuleCreateInfoNv",
		#{const VK_STRUCTURE_TYPE_CUDA_MODULE_CREATE_INFO_NV}),
	("StructureTypeCudaFunctionCreateInfoNv",
		#{const VK_STRUCTURE_TYPE_CUDA_FUNCTION_CREATE_INFO_NV}),
	("StructureTypeCudaLaunchInfoNv",
		#{const VK_STRUCTURE_TYPE_CUDA_LAUNCH_INFO_NV}),
	("StructureTypePhysicalDeviceCudaKernelLaunchFeaturesNv",
		#{const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUDA_KERNEL_LAUNCH_FEATURES_NV}),
	("StructureTypePhysicalDeviceCudaKernelLaunchPropertiesNv",
		#{const VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUDA_KERNEL_LAUNCH_PROPERTIES_NV}),
...
enum "ObjectType" ''#{type VkObjectType}
	...
	("ObjectTypeCudaModuleNv", #{const VK_OBJECT_TYPE_CUDA_MODULE_NV}),
	("ObjectTypeCudaFunctionNv", #{const VK_OBJECT_TYPE_CUDA_FUNCTION_NV}),
...
enum "ResolveModeFlagBits" ''#{type VkResolveModeFlagBits}
		[''Show, ''Eq, ''Storable, ''Bits] [
	("ResolveModeNone", #{const VK_RESOLVE_MODE_NONE}),
	("ResolveModeSampleZeroBit", #{const VK_RESOLVE_MODE_SAMPLE_ZERO_BIT}),
	("ResolveModeAverageBit", #{const VK_RESOLVE_MODE_AVERAGE_BIT}),
	("ResolveModeMinBit", #{const VK_RESOLVE_MODE_MIN_BIT}),
	("ResolveModeMaxBit", #{const VK_RESOLVE_MODE_MAX_BIT}),
	("ResolveModeExternalFormatDownsampleAndroid",
		#{const VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_ANDROID}),
	("ResolveModeNoneKhr", #{const VK_RESOLVE_MODE_NONE_KHR}),
	("ResolveModeSampleZeroBitKhr",
		#{const VK_RESOLVE_MODE_SAMPLE_ZERO_BIT_KHR}),
	("ResolveModeAverageBitKhr", #{const VK_RESOLVE_MODE_AVERAGE_BIT_KHR}),
	("ResolveModeMinBitKhr", #{const VK_RESOLVE_MODE_MIN_BIT_KHR}),
	("ResolveModeMaxBitKhr", #{const VK_RESOLVE_MODE_MAX_BIT_KHR}),
