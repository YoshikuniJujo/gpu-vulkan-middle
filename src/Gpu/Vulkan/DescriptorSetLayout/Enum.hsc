...
enum "CreateFlagBits" ''#{type VkDescriptorSetLayoutCreateFlagBits}
	...
	("CreatePushDescriptorBit",
		#{const VK_DESCRIPTOR_SET_LAYOUT_CREATE_PUSH_DESCRIPTOR_BIT}),
	...
	("CreateIndirectBindableBitNv",
		#{const VK_DESCRIPTOR_SET_LAYOUT_CREATE_INDIRECT_BINDABLE_BIT_NV}),
	("CreateHostOnlyPoolBitExt",
		#{const VK_DESCRIPTOR_SET_LAYOUT_CREATE_HOST_ONLY_POOL_BIT_EXT}),
	("CreatePerStageBitNv",
		#{const VK_DESCRIPTOR_SET_LAYOUT_CREATE_PER_STAGE_BIT_NV}),
